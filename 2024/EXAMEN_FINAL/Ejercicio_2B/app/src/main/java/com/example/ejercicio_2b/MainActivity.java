...
public class MainActivity extends AppCompatActivity {
    ...
    EditText etFileName, etFolderName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonCargar = findViewById(R.id.btn_cargar);
    ...
    public void writeFile(String texto, String nuevoNombreArchivo) {
        String nombreArchivo = RUTA_SD + nuevoNombreArchivo + ".txt";
    ...
    private void guardar() {
        ...
        String nuevoNombreArchivo = etFileName.getText().toString();
        writeFile(texto, nuevoNombreArchivo);
    }
}